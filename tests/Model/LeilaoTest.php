...
class LeilaoTest extends TestCase
{
    ...
    public function geraLances()
    {
        ...
        $leilaoCom2Lances->recebeLance(new Lance($weslley, 1000));
        $leilaoCom2Lances->recebeLance(new Lance($bianca, 2000));

        $leilaoCom1Lance = new Leilao('Fusca 1972 0KM');

        $leilaoCom1Lance->recebeLance(new Lance($bianca, 3000));
